...
export default function Room() {
  ...
  const [currentEnvironment, setCurrentEnvironment] = useState<'tea' | 'village'>('village');
  ...
  useEffect(() => {
    if (partnerUser?.currentEnvironment && 
  ...
  }, [partnerUser?.currentEnvironment, currentEnvironment, isChangingEnvironment]);
    ...
    <div className="min-h-screen bg-background">
      <div className="grid lg:grid-cols-[1fr_360px] gap-4 p-4">
        <div className="rounded-xl overflow-hidden border bg-card">
          <Tabs value={currentEnvironment} onValueChange={(value: 'tea' | 'village') => handleEnvironmentChange(value)} className="w-full">
          ...
          <Card>
            ...
            <CardContent className="space-y-3">
              <div className="grid grid-cols-2 gap-2">
                ...
                <div>
                  ...
                  <Input 
                    ...
                    placeholder={hasPartner ? "Partner connected" : "Waiting for partner..."} 
                    disabled 
                    className={partnerUser?.name ? "border-green-200 bg-green-50" : ""}
                  />
                </div>
              </div>
              <div className="grid grid-cols-2 gap-2">
              ...
              <div className="flex gap-2">
                ...
                />
                <Button onClick={send} disabled={!isConnected || !message.trim()}>
                  Send
                </Button>
              </div>
